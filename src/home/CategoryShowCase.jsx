...
const ProductData = [
{
imgUrl: 'src/assets/images/category/healthfitsunflower.jpg',
cate: 'HealthFit',
...
{
imgUrl: 'src/assets/images/category/bolas.jpg',
cate: 'Bolas',
title: 'Refined Rice Bran Oil',
...
{
imgUrl: 'src/assets/images/category/leadergold.jpg',
cate: 'LeaderGold',
title: 'Refined Palmolein Oil',
            ...
            <div className="section-header">
                ...
                <div className='course-filter-group'>
                    <ul className='lab-ul'>
                        ...
                        <li onClick={() => filterItem("HealthFit")}>Health Fit</li>
                        <li onClick={() => filterItem("Bolas")}>Bolas</li>
                        <li onClick={() => filterItem("LeaderGold")}>Leader Gold</li>
                    </ul>
                </div>
            </div>
